...
// ctl is PMONCNTCFG0~4??? start from 0x468, should be 8byte aligned
...
constexpr auto SERVER_MC_CH_PMON_CTL4_OFFSET      = SERVER_MC_CH_PMON_CTL0_OFFSET + 4*4;
...
constexpr auto SERVER_MC_CH_PMON_CTR4_OFFSET      = SERVER_MC_CH_PMON_CTR0_OFFSET + 8*4;
...
constexpr auto SERVER_UNCORE_COUNTER_MAX_COUNTERS    = 5;
