#define NGX_CONFIGURE " --prefix=/usr/local/nginx_fstack --with-ff_module --without-http_rewrite_module"

#ifndef NGX_COMPILER
#define NGX_COMPILER  "gcc 8.5.0 20210514 (Red Hat 8.5.0-6) (GCC) "
#endif
